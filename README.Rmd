...
A ```tranform_function``` can be specified in the ```infuse``` command. This allows for pre-processing of the parameter values before inserting them in the template.
